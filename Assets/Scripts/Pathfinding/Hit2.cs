...
public class Hit2 : MonoBehaviour
{
    ...
    private AgentBehavior2 getAgentBehavior()
    {
        AgentBehavior2 ab = null;
        if (this.transform.gameObject.tag == "Player")
        {
            ab = GetComponent<AgentBehavior2>();
        }
        else if (this.transform.gameObject.tag == "Missle" || this.transform.gameObject.tag == "HyperBeam")
        {
            ab = this.transform.parent.GetComponent<AgentBehavior2>();
        }
