...
public class Hit1 : MonoBehaviour
{
    ...
    private AgentBehavior1 getAgentBehavior()
    {
        AgentBehavior1 ab = null;
        if (this.transform.gameObject.tag == "Player")
        {
            ab = GetComponent<AgentBehavior1>();
        }
        else if (this.transform.gameObject.tag == "Missle" || this.transform.gameObject.tag == "HyperBeam")
        {
            ab = this.transform.parent.GetComponent<AgentBehavior1>();
        }
